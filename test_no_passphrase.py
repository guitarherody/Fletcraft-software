...
def create_test_payload_no_passphrase():
    # Build payment data
    payment_data = {
    ...
    # Generate signature WITHOUT passphrase (some gateways don't include it)
...
if __name__ == "__main__":
    print("PayFast NO PASSPHRASE Test")
    print("=" * 50)
    
    # Create test payload
    payment_data, signature_string = create_test_payload_no_passphrase()
    
    print("\nPAYMENT DATA:")
    for key, value in payment_data.items():
        print("  " + key + ": " + str(value))
    
    print("\nSIGNATURE STRING (NO PASSPHRASE):")
...
<html>
<head>
    <title>PayFast NO PASSPHRASE Test</title>
</head>
<body>
    <h1>PayFast NO PASSPHRASE Test</h1>
    ...
    <p><strong>Method:</strong> NO PASSPHRASE in signature</p>
...
'''
    ...
    <button onclick="document.getElementById('payfast_form').submit();">
        Submit NO PASSPHRASE Test to PayFast
    </button>
</body>
</html>'''
    
    with open('payfast_no_passphrase_test.html', 'w') as f:
        f.write(html_content)
    
    print("\nHTML Test File Created: payfast_no_passphrase_test.html")
    print("This excludes passphrase from signature generation")
    print("=" * 50) 